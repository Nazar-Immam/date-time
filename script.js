...
const hours = now.getHours() % 12 || 12 ;  // this becomes a condition so the true will get executed, and 0 is treated as false so 12 
...
timeElement.textContent = `${hours}:${mins}: ${se}`
